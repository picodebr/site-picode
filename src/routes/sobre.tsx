...
function SobrePage() {
  return (
    <>
      <section className="relative overflow-hidden bg-background text-foreground">
        ...
        <SpotlightHero className="relative">
          ...
          <div className="relative mx-auto max-w-5xl px-4 sm:px-6 pt-32 sm:pt-40 pb-16 sm:pb-20 text-center">
            ...
            <h1 className="mt-6 font-display text-[2.5rem] sm:text-5xl md:text-7xl font-bold leading-[1.02] tracking-tight">
      ...
      <section className="py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 grid lg:grid-cols-2 gap-10 md:gap-12 items-center">
          <motion.div
            ...
            className="aspect-[4/3] rounded-2xl md:rounded-3xl overflow-hidden shadow-elegant"
          >
          ...
          <div>
            ...
            <div className="mt-8 grid grid-cols-3 gap-3 sm:gap-4">
              <div className="rounded-2xl border border-border p-3 sm:p-4">
                <p className="font-display text-2xl sm:text-3xl font-bold text-gradient-blue">+9mil</p>
                <p className="text-[11px] sm:text-xs text-muted-foreground mt-1">alunos impactados</p>
              </div>
              <div className="rounded-2xl border border-border p-3 sm:p-4">
                <p className="font-display text-2xl sm:text-3xl font-bold text-gradient-blue">+200</p>
                <p className="text-[11px] sm:text-xs text-muted-foreground mt-1">professores formados</p>
              </div>
              <div className="rounded-2xl border border-border p-3 sm:p-4">
                <p className="font-display text-2xl sm:text-3xl font-bold text-gradient-blue">4</p>
                <p className="text-[11px] sm:text-xs text-muted-foreground mt-1">estados em ação</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-24 bg-[oklch(0.97_0.01_260)] dark:bg-secondary">
          ...
          <div className="mt-16 grid gap-6 md:grid-cols-3">
            {valores.map((v, i) => (
              <motion.div
                ...
                className="rounded-2xl md:rounded-3xl bg-card border border-border p-6 sm:p-8 shadow-card"
              >
      ...
      <section className="py-16 md:py-24">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 text-center">
          <h2 className="font-display text-2xl sm:text-3xl md:text-5xl font-bold uppercase tracking-tight">
