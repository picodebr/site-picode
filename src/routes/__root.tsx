...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "PiCode Education" },
      { property: "og:description", content: "Descubra novas formas de aproximar sua escola do futuro.  Conecte-se ao que há de mais novo no mundo do Pensamento Computacional." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "PiCode Education" },
      { name: "description", content: "Descubra novas formas de aproximar sua escola do futuro.  Conecte-se ao que há de mais novo no mundo do Pensamento Computacional." },
      { name: "twitter:description", content: "Descubra novas formas de aproximar sua escola do futuro.  Conecte-se ao que há de mais novo no mundo do Pensamento Computacional." },
